...
public class RechercheVilleAsyncTask extends AsyncTask<String, String, ArrayList<String>>  {
    private String data;
    private Intent intent;
    private Activity search;

    public RechercheVilleAsyncTask(Activity search){
        this.search = search;
    }
    ...
    protected ArrayList<String> doInBackground(String... params) {
        ...
        try {
            URL url = new URL("http://10.0.2.2/rechercheParVille.php?" + data);
